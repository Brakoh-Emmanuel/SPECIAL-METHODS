...
(A). CONSTRUCTORS IN PYTHON (__init__)
...
✓ Prepare the object for use immediately after creation
 ...
 (B).  STRING REPRESENTATION METHODS
...
(H).  Membership Testing: __contains__()
...
(J).  Iteration Support: __iter__() and __next__()
